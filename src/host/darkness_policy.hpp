...
// Decide whether startup discovery should open a disk automatically.  The GUI
// must never silently switch away from a source the user already opened, and
...
// Pure form of the Darkness drive-letter policy.  Bit 0 represents A:, bit 1
// B:, etc.  Keeping this independent from GetLogicalDrives() makes the policy
// deterministic and regression-testable on every CI platform.
